...
if ( ! function_exists( 'myarcade_thumbnail' ) ) {
  ...
  function myarcade_thumbnail( $args = array() ) {
    ...
    if ( $args['lazy_load'] ) {
      echo '<img itemprop="image" src="'.$args['lazy_placeholder'].'" data-src="'.$thumbnail.'" width="'.$args['width'].'" height="'.$args['height'].'" '.$args['class'].' alt="'.the_title_attribute( array( 'echo' => false ) ).'" /><noscript><img src="'.$thumbnail.'" width="'.$args['width'].'" height="'.$args['height'].'" '.$args['class'].' alt="'.the_title_attribute( array( 'echo' => false ) ).'" /></noscript>';
    }
    else {
