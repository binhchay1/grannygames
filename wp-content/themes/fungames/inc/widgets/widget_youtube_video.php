...
if ( !class_exists('WP_Widget_MABP_Youtube_Video') ) {
  class WP_Widget_MABP_Youtube_Video extends WP_Widget {
      ...
      function __construct(){
        ...
        parent::__construct('MABP_Youtube_Video', 'MyArcade Youtube Widget', $widget_ops);
      }
      ...
      function widget($args, $instance) {
        ...
        <div class="videowidget">
          <object width="320" height="250">
            ...
            <embed src="https://www.youtube.com/v/<?php echo $videoid; ?>&hl=en&fs=1&rel=0&border=1" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="320" height="250"></embed>
          </object>
        </div>
        <?php
