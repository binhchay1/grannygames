...
if ( !class_exists('WP_Widget_MABP_Banner_125') ) {
  class WP_Widget_MABP_Banner_125 extends WP_Widget {
    ...
    function __construct() {
      $widget_ops = array('description' => 'Declare up to six 125x125 advertisements to be displayed in a grid.');
      parent::__construct('MABP_Banner_125', 'MyArcade Ads - Square Buttons', $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        foreach($ads as $ad) {
          ...
          echo '<img src="' . $ad['img'] .'" alt="Advertisement" width="125" height="125" class="widgetad">';
          echo '</a>';
        }
    ...
    function form($instance) {
        $defaults = array('title' => 'Advertising'); //No defaults for this widget
