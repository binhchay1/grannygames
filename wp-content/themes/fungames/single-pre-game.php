<div id="content" class="content<?php echo get_option('fungames_sidebar_position'); ?>">
    ...
    <div class="cover">
      <div class="entry"
        ...
        <div class="alignright">
          ...
          $pre_banner = get_option('fungames_adpregame');
          if ( !empty($pre_banner) ) {
            echo stripslashes($pre_banner);
          }

          // Display Game Play Button
          fungames_play_link();
          ?>
          </center>
        </div>
  ...
  if ( (get_option('fungames_share_box') == 'enable') && (get_post_meta($post->ID, "mabp_game_type", true) != 'embed') ) {
    ...
    <div class="single_game">
      ...
      <p><?php esc_html_e("Embed this game on your MySpace or on your Website:", "fungames"); ?></p>
