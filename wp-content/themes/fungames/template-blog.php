...
<?php $blog_category = get_cat_ID( get_option('fungames_blog_category') ); ?>
    ...
    <div id="navigation">
      ...
      <?php else: ?>
        <div class="post-nav clearfix">
          <p id="previous"><?php next_posts_link(esc_html__('Older posts &laquo;', 'fungames')) ?></p>
          <p id="next-post"><?php previous_posts_link(esc_html__('&raquo; Newer posts', 'fungames')) ?></p>
        </div>
      <?php endif; ?>
    </div>
